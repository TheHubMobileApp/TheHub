 ...
 */
public class GetAdditionalFacebookFriendsTask extends AsyncTask<String, Void, String> {
    ...
    public GetAdditionalFacebookFriendsTask(Context context, ListView listview, ArrayList<HashMap<String, String>> usersArray, Activity parent_, String invited_ukeys) {
